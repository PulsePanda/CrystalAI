...
- If context is available in the project (project files, session logs, prior decisions), read it. Come in informed.
...
Be specific. "How will you handle errors?" is weak. "If the API returns a 503 mid-workflow, what does the user see?" is better.
...
Stay focused. One question per turn, move efficiently.
