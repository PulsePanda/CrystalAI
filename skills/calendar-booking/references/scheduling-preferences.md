...
## Person/Org-Specific Preferences
...
_Default durations by meeting type._

- Default: 30 minutes
- Vendor calls/demos: 30 minutes unless specified
...
_Catch-all for preferences that don't fit above._

- Buffer: at least 30 min between events
- Weekdays only unless explicitly told otherwise
- Propose 3-5 options spread across different days
