...
```bash
# Create folder: ~/Documents/[TopicName]_Research_[YYYYMMDD]/ (default path, configurable)
...
- Location: `~/Documents/[TopicName]_Research_[YYYYMMDD]/` (default — configurable via user settings)
